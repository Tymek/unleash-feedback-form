...
import { createSendFeedback } from './feedback';
...
export class Unleash extends EventEmitter {
  ...
  private sendFeedback: (toggleName: string, payload: number, context: Context) => Promise<void>;
  ...
  constructor({
    ...
    this.sendFeedback = createSendFeedback(
      unleashUrl,
      appName,
      unleashInstanceId,
      // FIXME: customHeadersFunction,
      customHeaders,
      timeout,
      httpOptions,
    )
